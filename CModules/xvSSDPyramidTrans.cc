...
PyMODINIT_FUNC initxvSSDPyramidTrans()  {
    (void) Py_InitModule("xvSSDPyramidTrans", xvInputMethods);
...
static PyObject* initialize(PyObject* self, PyObject* args) {
    ...
    new_tracker->stepper=new STEPPER_TYPE(template_in, new_tracker->scale, new_tracker->no_of_levels);
