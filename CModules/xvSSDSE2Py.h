...
static inline void numpyToXV() {
    //printf("in xvSSDSE2: numpyToXV with img_height=%d img_width=%d\n", img_height, img_width);
...
static inline void updateCorners(STATE_PAIR_TYPE& currentState, float scale=1.0) {
    ...
    for(int i=0; i<NCORNERS; i++) corners[i].setX((int)(corners[i].x()/scale)),
