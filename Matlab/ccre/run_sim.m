...
% Pre-computing Hessian matrix and image gradients
pre_computations;
...
for nb_image = nb_first_image +  1 : nb_last_image
    ...
    % Tracking    
    [H Warped] = tracking_ccre(ICur_gray, H, Hessian_inverse, Template, size_bin, n_bins, Nx, size_template_x, size_template_y, cte_t, spline_ref, epsilon, maxIters);
