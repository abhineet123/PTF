...
[Hessian Template_Jacobian] = generates_hessian(Template, Template, size_template_x, size_template_y, Nx);
...
for nb_image = nb_first_image +  1 : nb_last_image
    ...
    % Tracking
    [H, Warped] = tracking_ncc(ICur_gray, H, Hessian_inverse, Template_Jacobian, Template(:), Nx, size_template_x, size_template_y, maxIters, epsilon);
