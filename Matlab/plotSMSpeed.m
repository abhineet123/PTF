...
speed_ssd6=speed_ssd.data(:, 1:4);
speed_ssd4=speed_ssd.data(:, 5:8);
speed_ssd2=speed_ssd.data(:, 9:12);

speed_scv6=speed_scv.data(:, 1:4);
speed_scv4=speed_scv.data(:, 5:8);
speed_scv2=speed_scv.data(:, 9:12);

speed_ncc6=speed_ncc.data(:, 1:4);
speed_ncc4=speed_ncc.data(:, 5:8);
speed_ncc2=speed_ncc.data(:, 9:12);
