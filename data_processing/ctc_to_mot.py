...
def main():
    ...
    for seq_id in range(start_id, end_id + 1):
        ...
        seq_gt_path = linux_path(root_dir, actor, seq_name + '_GT', 'TRA')
        ...
        for frame_id in range(n_frames):
            ...
            if write_img:
                ...
                out_img_dir_path = linux_path(out_img_dir_path, out_img_file)
                cv2.imwrite(out_img_dir_path, seq_img)
