@echo off
python3 "%~dp0\..\visualizeWithMotion.py" on_top=0 top_border=0 keep_borders=1 n_images=1 random_mode=1 auto_progress=1 transition_interval=60 monitor_id=0  duplicate_window=0 second_from_top=1 win_offset_y=0 width=1920 height=1050 src_dirs=!!#,!!##,!!#bad,!!#proc,!!#seg_masks,!!#masks,!!#contours,. frg_win_titles="The Journal 8","4.m - Visual Studio Code" frg_monitor_ids=0,1,2,3,4,5 only_maximized=0 reversed_pos=2 min_aspect_ratio=0 auto_min_aspect_ratio=0 max_aspect_ratio=0 auto_aspect_ratio=0 max_magnified_height_ratio=0 save_magnified=1 id_probs=id_probs.csv n_images=1 contrast_factor=1 write_filenames=0 min_size=200 monitor_scale=1.25
